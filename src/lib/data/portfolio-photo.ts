...
export const PORTFOLIO_PHOTOS: PortfolioPhoto[] = [
  ...
  {"src": "/images/portfolio-photo/21-lieux-bouteille-de-vougeot-1er-cru-clos-blanc-.webp", "alt": "Bouteille de Vougeot 1er cru Clos Blanc, table de dégustation", "univers": "lieux", "client": null, "drone": false, "width": 1125, "height": 2000},
  {"src": "/images/portfolio-photo/22-lieux-brigade-au-dressage-des-assiettes-cuisin.webp", "alt": "Brigade au dressage des assiettes, cuisine de restaurant", "univers": "lieux", "client": null, "drone": false, "width": 1125, "height": 2000},
  ...
  {"src": "/images/portfolio-photo/25-corporate-portrait-d-un-vigneron-dans-ses-vignes-a.webp", "alt": "Portrait d'un vigneron dans ses vignes au coucher du soleil", "univers": "corporate", "client": "Domaine Arnaut Boué", "drone": false, "width": 1125, "height": 2000},
