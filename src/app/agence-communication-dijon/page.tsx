        ...
        <AnimateOnScroll>
          <div className="prose max-w-none">
            ...
            <p>
              ...
              On comprend votre marché parce qu&apos;on y vit — notre{" "}
              <Link href="/agence-communication-longvic">studio est basé à Longvic</Link>,
              dans la zone d&apos;activité, aux portes de Dijon.
            </p>
